...
class Nuvei_Pfw_Helper extends Nuvei_Pfw_Request {
    ...
    public function helper_is_nuvei_order($order_id, $return_respons = false) {
        return $this->is_nuvei_order($order_id, $return_respons);
    }
    
    public function helper_can_override_order_status($return_respons = false) {
        return $this->can_override_order_status($return_respons);
    }
    
    public function helper_check_for_repeating_dmn($trId, $status, $return_respons = false) {
        return $this->check_for_repeating_dmn($trId, $status, $return_respons);
    }
    
    public function helper_change_order_status(
        $order_id, 
        $req_status, 
        $transaction_type, 
        $refund_id = null,
    ...
    public function helper_update_order_meta($key, $data) {
    ...
    public function helper_get_order_meta($key) {
        if (! $this->sc_order instanceof WC_Order) {
            return false;
        }
    ...
    public function helper_get_order_status() {
        if (! $this->sc_order instanceof WC_Order) {
            return false;
        }
    ...
    public function helper_save_order() {
        if (! $this->sc_order instanceof WC_Order) {
            return false;
        }
