...
define(
	...
	array(
		...
		// translations
		'insuffFunds'       => __( 'You have Insufficient funds, please go back and remove some of the items in your shopping cart, or use another card.', 'nuvei_checkout_for_woocomm' ),
		'paymentDeclined'   => __( 'Your Payment was DECLINED. Please, try another payment option!', 'nuvei_checkout_for_woocomm' ),
		'paymentError'      => __( 'Error with your Payment.', 'nuvei_checkout_for_woocomm' ),
		'unexpectedError'   => __( 'Unexpected error. Please, try another payment option!', 'nuvei_checkout_for_woocomm' ),
		'fillFields'        => __( 'Please fill all fields marked with * !', 'nuvei_checkout_for_woocomm' ),
		'errorWithSToken'   => __( 'Error when try to get the Session Token.', 'nuvei_checkout_for_woocomm' ),
		'goBack'            => __( 'Go back', 'nuvei_checkout_for_woocomm' ),
		'RequestFail'       => __( 'Request fail.', 'nuvei_checkout_for_woocomm' ),
		'ApplePayError'     => __( 'Unexpected session error.', 'nuvei_checkout_for_woocomm' ),
		'TryAgainLater'     => __( 'Please try again later!', 'nuvei_checkout_for_woocomm' ),
		'TryAnotherPM'      => __( 'Please try another payment method!', 'nuvei_checkout_for_woocomm' ),
		'Pay'               => __( 'Pay', 'nuvei_checkout_for_woocomm' ),
		'PlaceOrder'        => __( 'Place order', 'nuvei_checkout_for_woocomm' ),
		'Continue'          => __( 'Continue', 'nuvei_checkout_for_woocomm' ),
		'refundQuestion'    => __( 'Are you sure about this Refund?', 'nuvei_checkout_for_woocomm' ),
		'LastDownload'      => __( 'Last Download', 'nuvei_checkout_for_woocomm' ),
		'ReadLog'           => __( 'Read Log', 'nuvei_checkout_for_woocomm' ),
		'RefreshLogError'   => __( 'Getting log faild, please check the console for more information!', 'nuvei_checkout_for_woocomm' ),
		'CheckoutFormError' => __( 'Checkout form class error, please contact the site administrator!', 'nuvei_checkout_for_woocomm' ),
		'TransactionAppr'   => __( 'The transaction was approved.', 'nuvei_checkout_for_woocomm' ),
	)
);
