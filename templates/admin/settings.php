...
if ( is_plugin_active( 'woocommerce-subscriptions' . DIRECTORY_SEPARATOR . 'woocommerce-subscriptions.php' )
	...
	<div class="error notice">
		<p><?php echo esc_html__( 'Looks like WCS plugin is activated. Please, do NOT USE products with WC Subscription and products with Nuvei Subscription in same site!!!', 'nuvei-payments-for-woocommerce' ); ?></p>
	</div>
<?php endif; ?>

<nav class="nav-tab-wrapper woo-nav-tab-wrapper">
	<a href="#nuvei_base_settings" class="nuvei_settings_tabs nav-tab" id="nuvei_base_settings_tab">
		<?php echo esc_html__( 'General Settings', 'nuvei-payments-for-woocommerce' ); ?>
	</a>
	<a href="#nuvei_advanced_settings" class="nuvei_settings_tabs nav-tab "id="nuvei_advanced_settings_tab">
		<?php echo esc_html__( 'Advanced Settings', 'nuvei-payments-for-woocommerce' ); ?>
	</a>
	<a href="#nuvei_tools" class="nuvei_settings_tabs nav-tab "id="nuvei_tools_tab">
		<?php echo esc_html__( 'Help Tools', 'nuvei-payments-for-woocommerce' ); ?>
	</a>
</nav>
