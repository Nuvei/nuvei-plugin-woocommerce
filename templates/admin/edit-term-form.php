...
<tr class="nuvei_meta_fileds">
	<th><?php echo esc_html__( 'Plan ID', 'nuvei-checkout-for-woocommerce' ); ?></th>
	<td>
...
<tr class="nuvei_meta_fileds">
	<th><?php echo esc_html__( 'Recurring Amount', 'nuvei-checkout-for-woocommerce' ); ?></th>
	<td>
		<input type="number" 
			   min="0" 
			   step=".01" 
...
<tr class="nuvei_meta_fileds">
	<th><?php echo esc_html__( 'Recurring Period', 'nuvei-checkout-for-woocommerce' ); ?></th>
	<td>
...
<tr class="nuvei_meta_fileds">
	<th><?php echo esc_html__( 'Recurring End After', 'nuvei-checkout-for-woocommerce' ); ?></th>
	<td>
...
<tr class="nuvei_meta_fileds">
	<th><?php echo esc_html__( 'Trial Period', 'nuvei-checkout-for-woocommerce' ); ?></th>
	<td>
